...
<section class="py-20 lg:py-32 bg-base-100" id="categories">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div
      use:reveal
      class="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-12 lg:mb-16"
    >
      <div>
        <p
        ...
        >
          Toutes les <em class="font-light text-primary not-italic"
            >catégories</em
          >
        </h2>
      </div>
      ...
      {#each categories as cat, i (cat.id ?? cat.slug)}
        <a
          ...
          class="group relative rounded-2xl overflow-hidden cursor-pointer
                 ...
                 {i === 0
            ? 'col-span-2 row-span-2 h-[340px] lg:h-[380px]'
            : 'col-span-1 h-40 lg:h-[180px]'}"
        >
          <!-- Image -->
          {#if imgSrc(cat.icon)}
            <img
          ...
          {:else}
            ...
            ></div>
            <span
              class="absolute inset-0 flex items-center justify-center text-5xl font-black text-primary/10 select-none pointer-events-none"
            >
          ...
          <!-- Overlay -->
          <div
            class="absolute inset-0 bg-linear-to-t from-base-100/90 via-base-100/20 to-transparent"
          ></div>
          ...
          <div class="absolute bottom-4 left-4">
            <p
              class="font-bold text-base-content {i === 0
            ...
            <p
              class="text-[10px] uppercase tracking-wider text-base-content/40 mt-0.5"
            >
